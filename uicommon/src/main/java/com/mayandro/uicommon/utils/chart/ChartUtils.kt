package com.mayandro.uicommon.utils.chart
...
object ChartUtils {
    ...
    fun fillChart(
        ...
        val lineDataSet = getLineDataSet(
            chartView,
            entries = chartDataModel.entries,
            chartName = name,
            lineColor = lineColor
        )
        ...
        val fillGradient = ContextCompat.getDrawable(chartView.context, graphFillGradient)
    ...
    private fun getLineDataSet(
        ...
        lineDataSet.apply {
            ...
            color = ContextCompat.getColor(chartView.context, lineColor)
